 ...
 * @author roger
 */
public class PersistenceUnitNode extends PersistenceExplorerNode {
    public static final String LAYER_FOLDER = "PersistenceUnitNode";
    private static final String ICON_BASE =
        "org/javaplus/netbeans/persistence/resources/persistence.gif";

    private PersistenceUnitNode(Lookup lookup) {
        super();
    ...
    public static Node getInstance(Lookup lookup) {
        return new PersistenceUnitNode(lookup);
    }
